...
CREATE TABLE IF NOT EXISTS `mydb`.`Users` (
  ...
  `Additional_idAdditional` INT NOT NULL,
  PRIMARY KEY (`idUsers`, `Additional_idAdditional`),
  INDEX `fk_Users_Additional1_idx` (`Additional_idAdditional` ASC) VISIBLE,
  CONSTRAINT `fk_Users_Additional1`
    FOREIGN KEY (`Additional_idAdditional`)
